...
<p><span class="chinese">富裕国际的宇宙天然能量瓶是一个不锈钢保温杯。</span><span class="english">FusionExcel Quantum Flask is a Stainless Steel Flask enhanced with Scalar Energy.</span></p>
...
<p><span class="chinese">如果您存储的是数字或字符串等标量值，那么将返回这些内容。</span><span class="english">If you stored a scalar value like a number or string, then that is what will come back.</span></p>

<p><span class="chinese">研究了一维线性标量守恒律初边值问题的弱解，分析了有限元方法的收敛性。</span><span class="english">In this paper, a finite element method for linear scalar conservation laws is analyzed.</span></p>
...
<p><span class="chinese">两个四元数相等的准则是，它们的数量部分相等。</span><span class="english">The criterion of equality of two quaternions is that their scalar parts shall be equal.</span></p>
