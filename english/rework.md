...
<p><span class="chinese">重复工作和废弃常常导致士气问题。</span><span class="english">Rework and scrapping frequently lead to morale issues.</span></p>

<p><span class="chinese">重做现已存在的管理执行处理过程。</span><span class="english">Rework the existing test management and execution process.</span></p>
...
<p><span class="chinese">利用非接触式拆焊技术，使线路板免受损坏。</span><span class="english">Adopted non-touch rework technique avoids damage of circuit board.</span></p>
...
<p><span class="chinese">如果某些项不正确，那么表单将被发送回第二步骤进行重新审核。</span><span class="english">If something is not right, the form is sent back to the second step for rework.</span></p>
...
<p><span class="chinese">正如程序员需要改变重做是浪费的观念，设计师也是一样。</span><span class="english">Just as programmers need to get over the idea that rework is waste, so do designers.</span></p>
...
<p><span class="chinese">当有产品检查不正常时，分析原因和危险可能，作拒收、再加工和放行的决定。</span><span class="english">When product is rejected, determine cause and assess risk, reject, rework or release.</span></p>

<p><span class="chinese">介绍了QFN的特点、分类、工艺要点和返修。</span><span class="english">The things of QFN's characteristics, division, technical gist and rework are described.</span></p>
