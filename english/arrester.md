...
<p><span class="chinese">寻找给定电气干扰时电涌放电器中的最大能量。</span><span class="english">To find the maximum energy in a surge arrester for a given electrical disturbance.</span></p>
...
<p><span class="chinese">为确保阻火器的性能达到安全使用的目的，对阻火器应定期进行检查、保养。</span><span class="english">A flame arrester should go through fire-tolerant test 1h without tempering during the period of test.</span></p>
...
<p><span class="chinese">阻火器设备是安装于焦化石油储罐上的重要安全设备。</span><span class="english">Flame arrester device is installed in the coking of oil storage tanks on the important safety equipment.</span></p>
...
<p><span class="chinese">阻火器的阻火层结构有砾石型、金属丝网型或波纹型。</span><span class="english">The flame arrester fire resistance reservoir structure have gravel type, type or corrugated metal screen type.</span></p>
...
<p><span class="chinese">若绝缘减少后仍同样地能被保护，那末避雷器额定值也必须相应降低。</span><span class="english">If the insulation is to be as well protected after it is reduced, the arrester rating must be correspondingly reduced.</span></p>
