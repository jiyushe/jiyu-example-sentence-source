...
<p><span class="chinese">用拟断面图做资料处理解释。</span><span class="english">The data is processed with pseudosectionof apparent resistivity.</span></p>

<p><span class="chinese">提出拟合应采用两组参数联合进行。</span><span class="english">The fitting should be done by using two sets of complex resistivity.</span></p>
...
<p><span class="chinese">同时，对比分析了不同井况和地层条件下井间电磁场的特征。</span><span class="english">The effects of casing pipe on cross-well resistivity logging were analyzed.</span></p>
...
<p><span class="chinese">这是数值分析中高斯赛德尔算法的实现程序。</span><span class="english">This is the numerical analysis of high resistivity algorithm implementation procedures.</span></p>
...
<p><span class="chinese">它非常的惧怕寒冷的天气，对于生病，它的抵抗力是很不好的。</span><span class="english">It unusual fears the cold weather, regarding falls ill, its resistivity is not very good.</span></p>
