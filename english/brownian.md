...
<p><span class="chinese">求出了布朗束缚振子的平均第一通过时间。</span><span class="english">The mean first-passage time of the Brownian bound oscillator is obtained.</span></p>
...
<p><span class="chinese">通过蒙特卡罗模拟方法，得到布郎粒子定向梯跳运动曲线。</span><span class="english">Through the numerical simulation, a direct stepping motion curve of single Brownian particle is obtained.</span></p>
...
<p><span class="chinese">文章论述了分形、分数维的基本概念，以及分数布朗运动的数学模型。</span><span class="english">The conceptions of fractal, fractal dimension and the mathematical model of fractional Brownian motion are discussed in this paper.</span></p>

<p><span class="chinese">对于单个布朗粒子的情形，我们给出了统一的微扰解析解，它对大、小阻尼情形均适用。</span><span class="english">For the single Brownian particle case, we give unified perturbative analytic expressions valid for both large and small friction cases.</span></p>
